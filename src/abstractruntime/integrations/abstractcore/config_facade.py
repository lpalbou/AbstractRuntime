...
- models & engines (AbstractCore >= 2.16.0): host profile, local-engine status and
...
# installed models, deletes and host jobs (AbstractCore >= 2.16.0)
# ---------------------------------------------------------------------------
#
...
MODELS_ENGINES_MIN_ABSTRACTCORE = "2.16.0"
